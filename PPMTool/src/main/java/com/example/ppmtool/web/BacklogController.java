...
public class BacklogController {
	...
	public Iterable<ProjectTask> getProjectBacklog(@RequestParam(value = "sortBy", defaultValue = "priority") String sortBy, @PathVariable String backlog_id, Principal principal){
		return projectTaskService.findBacklogById(sortBy, backlog_id, principal.getName());
	}
